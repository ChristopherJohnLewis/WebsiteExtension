(function () {
    ...
    const firebaseConfig = {
        apiKey: "AIzaSyBlGO-089jTQwF-sD5oqZA3G6JaqSPjDH4",
        authDomain: "christopher-lewis-resume.firebaseapp.com",
        databaseURL: "https://christopher-lewis-resume-default-rtdb.firebaseio.com",
        projectId: "christopher-lewis-resume",
        storageBucket: "christopher-lewis-resume.firebasestorage.app",
        messagingSenderId: "305354699589",
        appId: "1:305354699589:web:40277f203728707db5042c",
        measurementId: "G-LNM3ZD0CEQ"
    };
    ...
    // 2. Listen for popup DOM load
    document.addEventListener("DOMContentLoaded", () => {
      // 3. Grab the form and attach a submit listener
      ...
      form.addEventListener("submit", (e) => {
        ...
        // 4. Get user data from input fields
        ...
        browser.tabs.query({ active: true, currentWindow: true }).then((tabs) => {
          ...
          const messagesRef = ref(db, "media"); // or "messages/" + name if needed
          push(messagesRef, {
            url: activeTab.url,
            type: type,
